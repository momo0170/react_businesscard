  ...
  return (
    <div className={styles.frame}>
      ...
      <div className={styles.message}>
        ...
        cum explicabo iste mollitia! Lorem ipsum dolor sit, amet consectetur
        adipisicing elit. Iusto perspiciatis, illum maiores quos necessitatibus,
        sed aperiam totam, facilis corporis voluptatem ex quod velit quae vel
        ipsa. Assumenda aut incidunt corrupti!
      </div>
    </div>
  );
}
